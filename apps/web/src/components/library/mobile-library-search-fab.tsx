...
export function MobileLibrarySearchFab() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-6 z-30 flex justify-center px-6">
      <Button
        asChild
        className="pointer-events-auto h-14 w-14 rounded-full bg-black text-white shadow-lg hover:bg-zinc-900 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200"
      >
        <Link href="/search" aria-label="책 검색">
